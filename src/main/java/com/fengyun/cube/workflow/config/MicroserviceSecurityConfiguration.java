...
import com.fengyun.cube.core.config.AppNameProperties;
import com.fengyun.cube.core.security.AuthoritiesConstants;
import com.fengyun.cube.core.security.CubeBearerTokenExtractor;
import com.fengyun.cube.core.security.CubeBearerTokenExtractorGateway;
...
public class MicroserviceSecurityConfiguration extends ResourceServerConfigurerAdapter {
    ...
    @Autowired
    private CubeRedisClient cacheRPCClient;
    ...
    public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
        ...
        resources.tokenExtractor(new CubeBearerTokenExtractor(appNameProperties, cacheRPCClient,tokenServices));
 ...
 ;
    ...
    private String getKeyFromAuthorizationServer(RestTemplate keyUriRestTemplate) {
        ...
        return (String) keyUriRestTemplate
            .exchange("http://cubeuaa/oauth/token_key", HttpMethod.GET, request, Map.class).getBody()
            .get("value");
